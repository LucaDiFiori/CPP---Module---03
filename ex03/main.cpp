...
int main() {
    ...
    std::cout << "->DiamondTrap parameters:" << std::endl;
    ...
    std::cout << "->special abilities:" << std::endl;// Demonstrate special abilities
    ...
    std::cout << "Copied DiamondTrap parameters:" << std::endl;
